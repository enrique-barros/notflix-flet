"""
Hero Banner rediseñado — estilo Netflix real.
- Imagen de fondo simulada (gradiente grande)
- Rating, año, duración en pills
- Botones ft.Button (no deprecated ElevatedButton)
- expand=True para ser responsive
"""
