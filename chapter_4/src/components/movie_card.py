"""
MovieCard rediseñada — estilo Netflix real.
- Imagen simulada: gradiente único por título (hash del nombre)
- Aspect ratio 2:3 (poster)
- Overlay con info al hacer hover (via Stack)
- Sin ElevatedButton, sin deprecated APIs
"""

import flet as ft

from config.theme import (
    COLOR_CARD_BG, COLOR_PRIMARY, COLOR_SUBTEXT,
    COLOR_TEXT, FONT_SIZE_CARD_META, FONT_SIZE_CARD_TITLE,
